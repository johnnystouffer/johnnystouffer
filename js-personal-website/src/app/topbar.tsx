...
<nav className="flex items-center justify-between shadow-md">
  ...
  <ul className="flex gap-6 text-lg">
    ...
    <li className="p-4 cursor-pointer hover:underline">Experience</li>
    <li className="p-4 cursor-pointer hover:underline">Projects</li>
    <li className="p-4 cursor-pointer hover:underline">Other</li>
